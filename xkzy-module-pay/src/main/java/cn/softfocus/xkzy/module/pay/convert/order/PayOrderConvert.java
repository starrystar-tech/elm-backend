package cn.softfocus.xkzy.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, cn.softfocus.xkzy.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
