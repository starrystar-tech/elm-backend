package cn.softfocus.xkzy.module.pay.controller.admin.demo.vo.withdraw;
...
public class PayDemoWithdrawCreateReqVO {
    ...
    @Schema(description = "提现标题", requiredMode = Schema.RequiredMode.REQUIRED, example = "张三是一种菜")
