package cn.softfocus.xkzy.module.pay.framework.pay.core.client.impl.weixin;
...
import cn.softfocus.xkzy.framework.common.util.io.FileUtils;
...
import static cn.softfocus.xkzy.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V2;
import static cn.softfocus.xkzy.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V3;
...
public abstract class AbstractWxPayClient extends AbstractPayClient<WxPayClientConfig> {
    ...
    private SignatureHeader getRequestHeader(Map<String, String> headers) {
        // 参见 https://gitee.com/zhijiantianya/xkzy-cloud/issues/ICSFL6
