...
import cn.softfocus.xkzy.module.pay.framework.pay.core.client.impl.PayClientFactoryImpl;
import cn.softfocus.xkzy.module.pay.framework.pay.core.client.impl.alipay.AlipayPayClientConfig;
import cn.softfocus.xkzy.module.pay.framework.pay.core.client.impl.alipay.AlipayQrPayClient;
import cn.softfocus.xkzy.module.pay.framework.pay.core.client.impl.alipay.AlipayWapPayClient;
import cn.softfocus.xkzy.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig;
import cn.softfocus.xkzy.module.pay.framework.pay.core.client.impl.weixin.WxPubPayClient;
...
//        System.out.println(result);
    ...
    public void testCreatePayClient_ALIPAY_QR() {
        ...
        // 发起支付
        PayOrderUnifiedReqDTO reqDTO = buildPayOrderUnifiedReqDTO();
        reqDTO.setNotifyUrl("http://yunai.natapp1.cc/admin-api/pay/notify/callback/18");
    }
