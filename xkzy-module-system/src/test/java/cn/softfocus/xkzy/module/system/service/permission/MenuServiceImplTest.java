package cn.softfocus.xkzy.module.system.service.permission;
...
import cn.softfocus.xkzy.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
import cn.softfocus.xkzy.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import cn.softfocus.xkzy.module.system.dal.dataobject.permission.MenuDO;
import cn.softfocus.xkzy.module.system.dal.mysql.permission.MenuMapper;
import cn.softfocus.xkzy.module.system.enums.permission.MenuTypeEnum;
...
import static cn.softfocus.xkzy.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("张三").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
        ...
        // 准备参数
        MenuListReqVO reqVO = new MenuListReqVO().setName("三").setStatus(CommonStatusEnum.ENABLE.getStatus());
