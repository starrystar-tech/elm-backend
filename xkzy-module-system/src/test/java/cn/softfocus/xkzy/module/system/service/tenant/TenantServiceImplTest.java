package cn.softfocus.xkzy.module.system.service.tenant;
...
import cn.softfocus.xkzy.framework.tenant.config.TenantProperties;
...
import cn.softfocus.xkzy.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.softfocus.xkzy.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import cn.softfocus.xkzy.module.system.dal.dataobject.permission.MenuDO;
import cn.softfocus.xkzy.module.system.dal.dataobject.permission.RoleDO;
import cn.softfocus.xkzy.module.system.dal.dataobject.tenant.TenantDO;
import cn.softfocus.xkzy.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.softfocus.xkzy.module.system.dal.mysql.tenant.TenantMapper;
import cn.softfocus.xkzy.module.system.enums.permission.RoleCodeEnum;
import cn.softfocus.xkzy.module.system.enums.permission.RoleTypeEnum;
import cn.softfocus.xkzy.module.system.service.permission.MenuService;
import cn.softfocus.xkzy.module.system.service.permission.PermissionService;
import cn.softfocus.xkzy.module.system.service.permission.RoleService;
import cn.softfocus.xkzy.module.system.service.tenant.handler.TenantInfoHandler;
import cn.softfocus.xkzy.module.system.service.tenant.handler.TenantMenuHandler;
import cn.softfocus.xkzy.module.system.service.user.AdminUserService;
...
import static cn.softfocus.xkzy.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("企聚", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("企聚"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("企聚");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
