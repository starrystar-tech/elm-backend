package cn.softfocus.xkzy.module.system.service.user;
...
import cn.softfocus.xkzy.module.infra.api.config.ConfigApi;
import cn.softfocus.xkzy.module.infra.api.file.FileApi;
import cn.softfocus.xkzy.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.softfocus.xkzy.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.softfocus.xkzy.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.softfocus.xkzy.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.softfocus.xkzy.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.softfocus.xkzy.module.system.controller.admin.user.vo.user.UserSaveReqVO;
...
import cn.softfocus.xkzy.module.system.dal.dataobject.dept.UserPostDO;
import cn.softfocus.xkzy.module.system.dal.dataobject.tenant.TenantDO;
import cn.softfocus.xkzy.module.system.dal.dataobject.user.AdminUserDO;
import cn.softfocus.xkzy.module.system.dal.mysql.dept.UserPostMapper;
import cn.softfocus.xkzy.module.system.dal.mysql.user.AdminUserMapper;
import cn.softfocus.xkzy.module.system.enums.common.SexEnum;
import cn.softfocus.xkzy.module.system.service.dept.DeptService;
...
import static cn.softfocus.xkzy.framework.common.util.date.LocalDateTimeUtils.buildTime;
...
import static cn.softfocus.xkzy.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.softfocus.xkzy.framework.test.core.util.RandomUtils.*;
import static cn.softfocus.xkzy.module.system.enums.ErrorCodeConstants.*;
import static cn.softfocus.xkzy.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("xkzyyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("xkzyyuanma");
        ...
        assertEquals("xkzyyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("xkzyyuanma"))).thenReturn("java");
    ...
    public void testGetUserListByNickname() {
        // mock 数据
        AdminUserDO user = randomAdminUserDO(o -> o.setNickname("三头"));
        userMapper.insert(user);
        // 测试 nickname 不匹配
