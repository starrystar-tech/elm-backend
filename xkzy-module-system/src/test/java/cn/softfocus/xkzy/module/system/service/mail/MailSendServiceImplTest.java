package cn.softfocus.xkzy.module.system.service.mail;
...
import cn.softfocus.xkzy.framework.test.core.util.RandomUtils;
import cn.softfocus.xkzy.module.system.dal.dataobject.mail.MailAccountDO;
import cn.softfocus.xkzy.module.system.dal.dataobject.mail.MailTemplateDO;
import cn.softfocus.xkzy.module.system.dal.dataobject.user.AdminUserDO;
import cn.softfocus.xkzy.module.system.mq.message.mail.MailSendMessage;
import cn.softfocus.xkzy.module.system.mq.producer.mail.MailProducer;
...
//                .setFrom("奥特曼 <ydym_test@163.com>")
    ...
    public void testDoSendMail_success() {
        try (final MockedStatic<MailUtil> mailUtilMock = mockStatic(MailUtil.class)) {
            // 准备参数
            MailSendMessage message = randomPojo(MailSendMessage.class, o -> o.setNickname("张三"));
            // mock 方法（获得邮箱账号）
            ...
            mailUtilMock.when(() -> MailUtil.send(
                    argThat(mailAccount -> {
                        assertEquals("张三 <7685@qq.com>", mailAccount.getFrom());
