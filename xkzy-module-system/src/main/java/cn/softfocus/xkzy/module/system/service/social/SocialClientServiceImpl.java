package cn.softfocus.xkzy.module.system.service.social;
...
import cn.softfocus.xkzy.framework.common.util.cache.CacheUtils;
import cn.softfocus.xkzy.framework.common.util.http.HttpUtils;
import cn.softfocus.xkzy.framework.common.util.object.BeanUtils;
import cn.softfocus.xkzy.module.system.api.social.dto.SocialWxQrcodeReqDTO;
...
import cn.softfocus.xkzy.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.softfocus.xkzy.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.softfocus.xkzy.module.system.dal.dataobject.social.SocialClientDO;
import cn.softfocus.xkzy.module.system.dal.mysql.social.SocialClientMapper;
import cn.softfocus.xkzy.module.system.dal.redis.RedisKeyConstants;
import cn.softfocus.xkzy.module.system.enums.social.SocialTypeEnum;
...
import static cn.softfocus.xkzy.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.softfocus.xkzy.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${xkzy.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${xkzy.wxa-subscribe-message.miniprogram-state:formal}")
