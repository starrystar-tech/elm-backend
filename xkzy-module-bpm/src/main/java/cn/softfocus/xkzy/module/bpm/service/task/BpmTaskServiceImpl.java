package cn.softfocus.xkzy.module.bpm.service.task;
...
import cn.softfocus.xkzy.framework.common.util.date.DateUtils;
import cn.softfocus.xkzy.framework.common.util.number.NumberUtils;
import cn.softfocus.xkzy.framework.common.util.object.ObjectUtils;
import cn.softfocus.xkzy.framework.common.util.object.PageUtils;
import cn.softfocus.xkzy.framework.datapermission.core.annotation.DataPermission;
import cn.softfocus.xkzy.framework.web.core.util.WebFrameworkUtils;
import cn.softfocus.xkzy.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.softfocus.xkzy.module.bpm.controller.admin.task.vo.task.*;
import cn.softfocus.xkzy.module.bpm.convert.task.BpmTaskConvert;
import cn.softfocus.xkzy.module.bpm.dal.dataobject.definition.BpmFormDO;
import cn.softfocus.xkzy.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.softfocus.xkzy.module.bpm.enums.definition.*;
import cn.softfocus.xkzy.module.bpm.enums.task.BpmCommentTypeEnum;
import cn.softfocus.xkzy.module.bpm.enums.task.BpmReasonEnum;
import cn.softfocus.xkzy.module.bpm.enums.task.BpmTaskSignTypeEnum;
import cn.softfocus.xkzy.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.softfocus.xkzy.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.softfocus.xkzy.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.softfocus.xkzy.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import cn.softfocus.xkzy.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.softfocus.xkzy.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.softfocus.xkzy.module.bpm.service.definition.BpmFormService;
import cn.softfocus.xkzy.module.bpm.service.definition.BpmModelService;
import cn.softfocus.xkzy.module.bpm.service.definition.BpmProcessDefinitionService;
import cn.softfocus.xkzy.module.bpm.service.message.BpmMessageService;
...
import static cn.softfocus.xkzy.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static cn.softfocus.xkzy.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_RETURN_FLAG;
import static cn.softfocus.xkzy.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_SKIP_START_USER_NODE;
import static cn.softfocus.xkzy.module.bpm.framework.flowable.core.util.BpmnModelUtils.*;
...
//        }
    ...
    public void rejectTask(Long userId, @Valid BpmTaskRejectReqVO reqVO) {
        ...
        // 疑问：为什么要标记未通过呢？
        // 回答：例如说 A 任务被向前加签除 B 任务时，B 任务被审批不通过，此时 A 会被取消。而 xkzy-ui-admin-vue3 不展示“已取消”的任务，导致展示不出审批不通过的细节。
    ...
    public void delegateTask(Long userId, BpmTaskDelegateReqVO reqVO) {
        ...
        // 特殊：如果已经被委派（owner 非空），则不需要更新 owner：https://gitee.com/zhijiantianya/xkzy-cloud/issues/ICJ153
    ...
    public void transferTask(Long userId, BpmTaskTransferReqVO reqVO) {
        ...
        // 3.1 设置任务所有人 (owner) 为原任务的处理人 (assignee)
        // 特殊：如果已经被转派（owner 非空），则不需要更新 owner：https://gitee.com/zhijiantianya/xkzy-cloud/issues/ICJ153
        if (StrUtil.isEmpty(task.getOwner())) {
            taskService.setOwner(taskId, task.getAssignee());
        }
    ...
    public void processTaskCreated(Task task) {
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
             ...
             * 参见 <a href="https://gitee.com/zhijiantianya/xkzy-cloud/issues/IB7V7Q">issue</a> 反馈
             */
            @Override
    ...
    public void processTaskAssigned(Task task) {
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
            ...
            public void afterCompletion(int transactionStatus) {
                ...
                // 自动去重，通过自动审批的方式 TODO @张三 驳回的情况得考虑一下；@lesan：驳回后，又自动审批么？
