package cn.softfocus.xkzy.module.erp.controller.admin.stock.vo.in;
...
import static cn.softfocus.xkzy.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockInRespVO {
    ...
    @Schema(description = "供应商名称", example = "企聚")
    @ExcelProperty("供应商名称")
    ...
    @Schema(description = "创建人", example = "企聚")
    private String creator;
    @Schema(description = "创建人名称", example = "企聚")
