package cn.softfocus.xkzy.module.product.controller.app.spu.vo;

import cn.softfocus.xkzy.module.product.controller.app.property.vo.value.AppProductPropertyValueDetailRespVO;
...
public class AppProductSpuDetailRespVO {
    ...
    @Schema(description = "商品名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "企聚")
    private String name;
