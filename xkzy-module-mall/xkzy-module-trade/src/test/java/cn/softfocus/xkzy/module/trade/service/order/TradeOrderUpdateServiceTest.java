...
import cn.softfocus.xkzy.module.promotion.api.coupon.CouponApi;
...
import cn.softfocus.xkzy.module.trade.enums.order.TradeOrderRefundStatusEnum;
import cn.softfocus.xkzy.module.trade.enums.order.TradeOrderStatusEnum;
import cn.softfocus.xkzy.module.trade.framework.order.config.TradeOrderConfig;
import cn.softfocus.xkzy.module.trade.framework.order.config.TradeOrderProperties;
import cn.softfocus.xkzy.module.trade.service.cart.CartServiceImpl;
import cn.softfocus.xkzy.module.trade.service.delivery.DeliveryExpressService;
import cn.softfocus.xkzy.module.trade.service.delivery.DeliveryExpressServiceImpl;
import cn.softfocus.xkzy.module.trade.service.message.TradeMessageServiceImpl;
import cn.softfocus.xkzy.module.trade.service.order.handler.TradeOrderHandler;
import cn.softfocus.xkzy.module.trade.service.price.TradePriceServiceImpl;
import cn.softfocus.xkzy.module.trade.service.price.calculator.TradePriceCalculator;
...
//        // mock 方法（用户收件地址的校验）
//        MemberAddressRespDTO addressRespDTO = new MemberAddressRespDTO().setId(10L).setUserId(userId).setName("张三")
...
//        assertEquals(tradeOrderDO.getReceiverName(), "张三");
