package cn.softfocus.xkzy.framework.quartz.core.handler;

import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.lang.Assert;
import cn.hutool.core.thread.ThreadUtil;
import cn.softfocus.xkzy.framework.quartz.core.enums.JobDataKeyEnum;
import cn.softfocus.xkzy.framework.quartz.core.service.JobLogFrameworkService;
...
public class JobHandlerInvoker extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext executionContext) throws JobExecutionException {
        ...
        log.info("jobId:{},jobHandlerName:{},jobLogId:{},data:{},exception:", jobId, jobHandlerName, jobLogId, data, exception);
