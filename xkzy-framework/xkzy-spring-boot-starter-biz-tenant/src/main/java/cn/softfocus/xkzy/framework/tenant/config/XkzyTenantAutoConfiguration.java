package cn.softfocus.xkzy.framework.tenant.config;
...
import cn.softfocus.xkzy.framework.redis.config.XkzyCacheProperties;
import cn.softfocus.xkzy.framework.security.core.service.SecurityFrameworkService;
import cn.softfocus.xkzy.framework.tenant.core.aop.TenantIgnore;
import cn.softfocus.xkzy.framework.tenant.core.aop.TenantIgnoreAspect;
import cn.softfocus.xkzy.framework.tenant.core.db.TenantDatabaseInterceptor;
import cn.softfocus.xkzy.framework.tenant.core.job.TenantJobAspect;
import cn.softfocus.xkzy.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import cn.softfocus.xkzy.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import cn.softfocus.xkzy.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import cn.softfocus.xkzy.framework.tenant.core.redis.TenantRedisCacheManager;
import cn.softfocus.xkzy.framework.tenant.core.security.TenantSecurityWebFilter;
import cn.softfocus.xkzy.framework.tenant.core.service.TenantFrameworkService;
import cn.softfocus.xkzy.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.softfocus.xkzy.framework.tenant.core.web.TenantContextWebFilter;
import cn.softfocus.xkzy.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "xkzy.tenant", value = "enable", matchIfMissing = true) // 允许使用 xkzy.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class XkzyTenantAutoConfiguration {
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     XkzyCacheProperties xkzyCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(xkzyCacheProperties.getRedisScanBatchSize()));
