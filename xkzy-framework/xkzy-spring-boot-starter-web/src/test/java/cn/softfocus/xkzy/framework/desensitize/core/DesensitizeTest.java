package cn.softfocus.xkzy.framework.desensitize.core;

import cn.softfocus.xkzy.framework.common.util.json.JsonUtils;
import cn.softfocus.xkzy.framework.desensitize.core.annotation.Address;
import cn.softfocus.xkzy.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.softfocus.xkzy.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.softfocus.xkzy.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("企聚源码");
        ...
        desensitizeDemo.setRegex("你好，我是企聚源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("企聚源码");

        // 调用
        DesensitizeDemo d = JsonUtils.parseObject(JsonUtils.toJsonString(desensitizeDemo), DesensitizeDemo.class);
        // 断言
        assertNotNull(d);
        assertEquals("三***", d.getNickname());
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "企聚源码", replacer = "*")
