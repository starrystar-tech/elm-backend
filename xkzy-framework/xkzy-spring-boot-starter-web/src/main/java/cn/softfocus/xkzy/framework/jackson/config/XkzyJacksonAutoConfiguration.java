package cn.softfocus.xkzy.framework.jackson.config;

import cn.softfocus.xkzy.framework.common.util.json.JsonUtils;
import cn.softfocus.xkzy.framework.common.util.json.databind.NumberSerializer;
import cn.softfocus.xkzy.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.softfocus.xkzy.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class XkzyJacksonAutoConfiguration {
