package cn.softfocus.xkzy.module.crm.controller.admin.contact.vo;
...
public class CrmContactRespVO {
    ...
    @DictFormat(cn.softfocus.xkzy.module.system.enums.DictTypeConstants.USER_SEX)
    private Integer sex;
    ...
    @Schema(description = "直属上级名", example = "三头")
