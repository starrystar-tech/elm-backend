package cn.softfocus.xkzy.module.crm.controller.admin.customer;
...
import cn.softfocus.xkzy.module.crm.service.customer.CrmCustomerPoolConfigService;
...
public class CrmCustomerController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<CrmCustomerImportExcelVO> list = Arrays.asList(
                CrmCustomerImportExcelVO.builder().name("企聚").industryId(1).level(1).source(1)
