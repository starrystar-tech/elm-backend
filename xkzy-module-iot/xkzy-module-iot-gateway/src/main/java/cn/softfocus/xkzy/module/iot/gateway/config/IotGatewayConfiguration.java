package cn.softfocus.xkzy.module.iot.gateway.config;

import cn.softfocus.xkzy.module.iot.core.messagebus.core.IotMessageBus;
import cn.softfocus.xkzy.module.iot.gateway.protocol.emqx.IotEmqxAuthEventProtocol;
import cn.softfocus.xkzy.module.iot.gateway.protocol.emqx.IotEmqxDownstreamSubscriber;
import cn.softfocus.xkzy.module.iot.gateway.protocol.emqx.IotEmqxUpstreamProtocol;
import cn.softfocus.xkzy.module.iot.gateway.protocol.http.IotHttpDownstreamSubscriber;
import cn.softfocus.xkzy.module.iot.gateway.protocol.http.IotHttpUpstreamProtocol;
import cn.softfocus.xkzy.module.iot.gateway.protocol.mqtt.IotMqttDownstreamSubscriber;
import cn.softfocus.xkzy.module.iot.gateway.protocol.mqtt.IotMqttUpstreamProtocol;
import cn.softfocus.xkzy.module.iot.gateway.protocol.mqtt.manager.IotMqttConnectionManager;
import cn.softfocus.xkzy.module.iot.gateway.protocol.mqtt.router.IotMqttDownstreamHandler;
import cn.softfocus.xkzy.module.iot.gateway.protocol.tcp.IotTcpDownstreamSubscriber;
import cn.softfocus.xkzy.module.iot.gateway.protocol.tcp.IotTcpUpstreamProtocol;
...
public class IotGatewayConfiguration {
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "xkzy.iot.gateway.protocol.http", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "xkzy.iot.gateway.protocol.emqx", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "xkzy.iot.gateway.protocol.tcp", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "xkzy.iot.gateway.protocol.mqtt", name = "enabled", havingValue = "true")
    @Slf4j
