package cn.softfocus.xkzy.module.iot.controller.admin.rule.vo.data.rule;
...
public class IotDataRuleRespVO {
    ...
    @Schema(description = "数据流转规则名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "张三")
    private String name;
