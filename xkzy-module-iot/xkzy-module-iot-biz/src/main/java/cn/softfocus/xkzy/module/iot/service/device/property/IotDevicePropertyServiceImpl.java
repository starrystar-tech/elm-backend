package cn.softfocus.xkzy.module.iot.service.device.property;
...
import cn.softfocus.xkzy.module.iot.controller.admin.device.vo.property.IotDevicePropertyHistoryListReqVO;
import cn.softfocus.xkzy.module.iot.controller.admin.device.vo.property.IotDevicePropertyRespVO;
...
import cn.softfocus.xkzy.module.iot.dal.dataobject.device.IotDevicePropertyDO;
import cn.softfocus.xkzy.module.iot.dal.dataobject.product.IotProductDO;
import cn.softfocus.xkzy.module.iot.dal.dataobject.thingmodel.IotThingModelDO;
import cn.softfocus.xkzy.module.iot.dal.dataobject.thingmodel.model.dataType.ThingModelDateOrTextDataSpecs;
import cn.softfocus.xkzy.module.iot.dal.redis.device.DevicePropertyRedisDAO;
import cn.softfocus.xkzy.module.iot.dal.redis.device.DeviceReportTimeRedisDAO;
import cn.softfocus.xkzy.module.iot.dal.redis.device.DeviceServerIdRedisDAO;
import cn.softfocus.xkzy.module.iot.dal.tdengine.IotDevicePropertyMapper;
import cn.softfocus.xkzy.module.iot.enums.thingmodel.IotDataSpecsDataTypeEnum;
import cn.softfocus.xkzy.module.iot.enums.thingmodel.IotThingModelTypeEnum;
import cn.softfocus.xkzy.module.iot.framework.tdengine.core.TDengineTableField;
import cn.softfocus.xkzy.module.iot.service.product.IotProductService;
import cn.softfocus.xkzy.module.iot.service.thingmodel.IotThingModelService;
...
public class IotDevicePropertyServiceImpl implements IotDevicePropertyService {
    ...
    public void saveDeviceProperty(IotDeviceDO device, IotDeviceMessage message) {
        ...
        // 1. 根据物模型，拼接合法的属性
        // TODO @张三：【待定 004】赋能后，属性到底以 thingModel 为准（ik），还是 db 的表结构为准（tl）？
