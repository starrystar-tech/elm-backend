package cn.softfocus.xkzy.module.iot.job.device;
...
import cn.softfocus.xkzy.module.iot.framework.iot.config.XkzyIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private XkzyIotProperties iotProperties;
