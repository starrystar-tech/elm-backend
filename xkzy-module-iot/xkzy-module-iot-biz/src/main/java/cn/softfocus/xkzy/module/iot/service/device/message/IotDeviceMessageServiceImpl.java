package cn.softfocus.xkzy.module.iot.service.device.message;
...
import cn.softfocus.xkzy.module.iot.controller.admin.device.vo.message.IotDeviceMessagePageReqVO;
import cn.softfocus.xkzy.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageReqVO;
import cn.softfocus.xkzy.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageSummaryByDateRespVO;
import cn.softfocus.xkzy.module.iot.core.enums.IotDeviceMessageMethodEnum;
...
import cn.softfocus.xkzy.module.iot.dal.dataobject.device.IotDeviceMessageDO;
import cn.softfocus.xkzy.module.iot.dal.tdengine.IotDeviceMessageMapper;
import cn.softfocus.xkzy.module.iot.service.device.IotDeviceService;
import cn.softfocus.xkzy.module.iot.service.device.property.IotDevicePropertyService;
import cn.softfocus.xkzy.module.iot.service.ota.IotOtaTaskRecordService;
...
import static cn.softfocus.xkzy.module.iot.enums.ErrorCodeConstants.DEVICE_DOWNSTREAM_FAILED_SERVER_ID_NULL;
...
public class IotDeviceMessageServiceImpl implements IotDeviceMessageService {
    ...
    // TODO @张三：针对连接网关的设备，是不是 productKey、deviceName 需要调整下；
    @Override
    ...
    private IotDeviceMessage sendDeviceMessage(IotDeviceMessage message, IotDeviceDO device, String serverId) {
        ...
        // TODO 张三：【设计】下行消息需要区分 PUSH 和 PULL 模型
    ...
    // TODO @张三：可优化：未来逻辑复杂后，可以独立拆除 Processor 处理器
