package cn.softfocus.xkzy.module.iot.service.product;
...
import cn.softfocus.xkzy.module.iot.controller.admin.product.vo.product.IotProductPageReqVO;
import cn.softfocus.xkzy.module.iot.controller.admin.product.vo.product.IotProductSaveReqVO;
import cn.softfocus.xkzy.module.iot.dal.dataobject.product.IotProductDO;
import cn.softfocus.xkzy.module.iot.dal.mysql.product.IotProductMapper;
...
public class IotProductServiceImpl implements IotProductService {
    ...
    public void updateProductStatus(Long id, Integer status) {
        ...
        // TODO @张三：【待定 001】1）是否需要操作后，在 redis 进行缓存，实现一个“快照”的情况，类似 tl；
