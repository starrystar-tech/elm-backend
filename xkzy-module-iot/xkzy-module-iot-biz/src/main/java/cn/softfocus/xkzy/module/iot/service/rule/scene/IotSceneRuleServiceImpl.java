package cn.softfocus.xkzy.module.iot.service.rule.scene;
...
import cn.softfocus.xkzy.module.iot.controller.admin.rule.vo.scene.IotSceneRulePageReqVO;
import cn.softfocus.xkzy.module.iot.controller.admin.rule.vo.scene.IotSceneRuleSaveReqVO;
...
import cn.softfocus.xkzy.module.iot.dal.mysql.rule.IotSceneRuleMapper;
import cn.softfocus.xkzy.module.iot.enums.rule.IotSceneRuleTriggerTypeEnum;
import cn.softfocus.xkzy.module.iot.framework.job.core.IotSchedulerManager;
...
import cn.softfocus.xkzy.module.iot.service.rule.scene.action.IotSceneRuleAction;
import cn.softfocus.xkzy.module.iot.service.rule.scene.matcher.IotSceneRuleMatcherManager;
...
import static cn.softfocus.xkzy.module.iot.enums.ErrorCodeConstants.RULE_SCENE_NOT_EXISTS;
...
public class IotSceneRuleServiceImpl implements IotSceneRuleService {
    ...
    public void executeSceneRuleByDevice(IotDeviceMessage message) {
        // TODO @张三：这里的 tenantId，通过设备获取；@puhui999：
    ...
    private List<IotSceneRuleDO> getMatchedSceneRuleListByMessage(IotDeviceMessage message) {
        // 1. 匹配设备
        // TODO @张三：可能需要 getSelf(); 缓存 @puhui999；
