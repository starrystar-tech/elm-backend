...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.softfocus";
    private static final String ARTIFACT_ID = "xkzy";
    private static final String PACKAGE_NAME = "cn.softfocus.xkzy";
    private static final String TITLE = "软聚企业信息化平台";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.softfocus";
        String artifactIdNew = "xkzy";
        String packageNameNew = "cn.softfocus.xkzy";
        String titleNew = "软聚企业信息化平台";
