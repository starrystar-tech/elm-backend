package cn.softfocus.xkzy.module.ai.framework.ai.core.model;
...
import cn.softfocus.xkzy.framework.common.util.spring.SpringUtils;
import cn.softfocus.xkzy.module.ai.enums.model.AiPlatformEnum;
import cn.softfocus.xkzy.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.softfocus.xkzy.module.ai.framework.ai.config.XkzyAiProperties;
...
import cn.softfocus.xkzy.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.softfocus.xkzy.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            XkzyAiProperties.Midjourney properties = SpringUtil.getBean(XkzyAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(XkzyAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        XkzyAiProperties.DouBao properties = new XkzyAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(XkzyAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        XkzyAiProperties.HunYuan properties = new XkzyAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(XkzyAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        XkzyAiProperties.SiliconFlow properties = new XkzyAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(XkzyAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        XkzyAiProperties.XingHuo properties = new XkzyAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(XkzyAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        XkzyAiProperties.BaiChuan properties = new XkzyAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(XkzyAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        XkzyAiProperties.Gemini properties = SpringUtil.getBean(XkzyAiProperties.class)
