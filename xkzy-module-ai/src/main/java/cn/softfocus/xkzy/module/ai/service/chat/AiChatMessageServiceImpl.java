package cn.softfocus.xkzy.module.ai.service.chat;
...
import cn.softfocus.xkzy.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import cn.softfocus.xkzy.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import cn.softfocus.xkzy.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import cn.softfocus.xkzy.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import cn.softfocus.xkzy.module.ai.dal.dataobject.chat.AiChatConversationDO;
import cn.softfocus.xkzy.module.ai.dal.dataobject.chat.AiChatMessageDO;
import cn.softfocus.xkzy.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import cn.softfocus.xkzy.module.ai.dal.dataobject.model.AiChatRoleDO;
...
import cn.softfocus.xkzy.module.ai.dal.mysql.chat.AiChatMessageMapper;
import cn.softfocus.xkzy.module.ai.enums.ErrorCodeConstants;
...
import cn.softfocus.xkzy.module.ai.service.knowledge.AiKnowledgeDocumentService;
import cn.softfocus.xkzy.module.ai.service.knowledge.AiKnowledgeSegmentService;
import cn.softfocus.xkzy.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import cn.softfocus.xkzy.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import cn.softfocus.xkzy.module.ai.service.model.AiChatRoleService;
import cn.softfocus.xkzy.module.ai.service.model.AiModelService;
import cn.softfocus.xkzy.module.ai.service.model.AiToolService;
import cn.softfocus.xkzy.module.ai.util.AiUtils;
import cn.softfocus.xkzy.module.ai.util.FileTypeUtils;
...
import static cn.softfocus.xkzy.framework.common.pojo.CommonResult.error;
...
import static cn.softfocus.xkzy.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static cn.softfocus.xkzy.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 xkzy.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 xkzy.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
    ...
    public Flux<CommonResult<AiChatMessageSendRespVO>> sendChatMessageStream(AiChatMessageSendReqVO sendReqVO,
        ...
        // 4.2 构建 Prompt，并进行调用
        Prompt prompt = buildPrompt(conversation, historyMessages, knowledgeSegments, webSearchResponse, model, sendReqVO);
        log.info("[sendChatMessageStream][prompt({})]", prompt);
        ...
        return streamResponse.map(chunk -> {
            ...
            if (throwable instanceof WebClientResponseException.BadRequest badRequest) {
                log.error("[sendChatMessageStream][userId({}) sendReqVO({}) 发生400错误，响应内容: {}]",
                        userId, sendReqVO, badRequest.getResponseBodyAsString());
            }
