package cn.softfocus.xkzy.module.ai.dal.dataobject.model;

import cn.softfocus.xkzy.framework.mybatis.core.dataobject.BaseDO;
import cn.softfocus.xkzy.module.ai.tool.function.DirectoryListToolFunction;
import cn.softfocus.xkzy.module.ai.tool.function.WeatherQueryToolFunction;
...
public class AiToolDO extends BaseDO {
     ...
     * 状态
     *
     * 枚举 {@link cn.softfocus.xkzy.framework.common.enums.CommonStatusEnum}
     */
