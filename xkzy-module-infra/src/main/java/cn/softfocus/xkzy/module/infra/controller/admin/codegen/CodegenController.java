package cn.softfocus.xkzy.module.infra.controller.admin.codegen;
...
import cn.softfocus.xkzy.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.softfocus.xkzy.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.softfocus.xkzy.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.softfocus.xkzy.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.softfocus.xkzy.module.infra.convert.codegen.CodegenConvert;
...
import cn.softfocus.xkzy.module.infra.service.codegen.CodegenService;
...
import static cn.softfocus.xkzy.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static cn.softfocus.xkzy.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "xkzy"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "企聚")
    })
