package cn.softfocus.xkzy.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(cn.softfocus.xkzy.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "企聚源码，牛逼！")
    @ExcelProperty("结果提示")
