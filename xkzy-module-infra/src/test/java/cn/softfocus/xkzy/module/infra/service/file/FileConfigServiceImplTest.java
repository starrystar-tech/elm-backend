package cn.softfocus.xkzy.module.infra.service.file;
...
import cn.softfocus.xkzy.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
...
import cn.softfocus.xkzy.module.infra.dal.mysql.file.FileConfigMapper;
import cn.softfocus.xkzy.module.infra.framework.file.core.client.FileClient;
import cn.softfocus.xkzy.module.infra.framework.file.core.client.FileClientConfig;
import cn.softfocus.xkzy.module.infra.framework.file.core.client.FileClientFactory;
import cn.softfocus.xkzy.module.infra.framework.file.core.client.local.LocalFileClient;
import cn.softfocus.xkzy.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import cn.softfocus.xkzy.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static cn.softfocus.xkzy.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static cn.softfocus.xkzy.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("企聚源码")
