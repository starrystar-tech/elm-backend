package cn.softfocus.xkzy.module.infra.service.logger;
...
import cn.softfocus.xkzy.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.softfocus.xkzy.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.softfocus.xkzy.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.softfocus.xkzy.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.softfocus.xkzy.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.softfocus.xkzy.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("xkzy-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("xkzy-test");
